...
class CSTRModel:
    ...
    def cost(self, y: np.ndarray, u: np.ndarray, ref: np.ndarray | None = None) -> float:
    ...
    def get_steady_state(self):
        return self.ss_x.copy(), self.ss_u.copy(), self.ss_y.copy(), self.ss_p.copy(), self.ref1.copy()
